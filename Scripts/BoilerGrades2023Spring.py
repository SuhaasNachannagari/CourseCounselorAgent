...
file_path = "../RawBoilerGrades/rawgrades2023spring.csv"

df = pd.read_csv(file_path, skiprows=6, header=1)
...
df.drop(columns=["Section", "CRN", "Academic Period", 'Unnamed: 35'], inplace=True)
